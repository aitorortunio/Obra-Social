...
<form action="{{ route('store-miembro-Admin', ['titularId' => $titular_id]) }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
        ...
        <label  class="col-sm-2 col-form-label mb-4">Apellido</label>
          ...
          <div class="col text-center">
            ...
            <a href="{{route('afiliate-showAfiliado', ['dni' => $titular_id])}}" onclick="return confirm('¿Desea cancelar la operacion?')" class="btn btn-dark">Cancelar</a> 
          </div>
    </div>
  </form>
  @endsection