...
<div class="col-sm-3 w-full "><h3><b>Mis datos</b></h3></div>
  ...
  <form action="{{ route('afiliate-update-misDatos', ['id' => $afiliado->dni]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
                ...
                <tbody>
                  ...
                  @foreach($miembros as $miembro)
                    <tr>
                      ...
                      <td>
                      <div class="row">
                        <a href="{{route('eliminar-miembro', ['id' => $miembro->id])}}" type="button" class="btn btn-dark" onclick="return confirm('¿Desea dar de baja al miembro?')">Dar de baja</a>
